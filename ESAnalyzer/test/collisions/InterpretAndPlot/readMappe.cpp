...
//      }
  ...
  map_Z0P0->Draw("colz");
  cc->Print(Form("mappe_AllRuns/Average_timing_Z%dP%d.png", Zside_i, Pside_i), "png");
  cc->Print(Form("mappe_AllRuns/Average_timing_Z%dP%d.pdf", Zside_i, Pside_i), "pdf");
  ...
  cc->Print(Form("mappe_AllRuns/Average_timing_Z%dP%d_check.png", Zside_i, Pside_i), "png");
  cc->Print(Form("mappe_AllRuns/Average_timing_Z%dP%d_check.pdf", Zside_i, Pside_i), "pdf");
